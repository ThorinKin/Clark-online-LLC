...
export const products = [
  // AI Conversation Packages
  {
    ...
    type: 'conversation',
    currency: 'USD',
    nmiSku: 'conv-trial',  // NMI SKU ¸¶·ÑÁ÷³ÌÓ³Éä
    price: 0.99,
    credits: 5,
    description: 'Perfect for trying out our AI conversation technology',
    popular: false,
  ...
  // AI Image-to-Video Packages
  {
    ...
    price: 39.99,
    credits: 100,
    description: 'Get started with AI-powered video generation',
    popular: false,
  ...
  },
  {
    ...
    type: 'video',
    currency: 'USD',
    nmiSku: 'video-standard',
    price: 99.99,
    credits: 300,
    description: 'Perfect for regular video content creation',
    popular: true,
  ...
  },
  {
    ...
    type: 'video',
    currency: 'USD',
    nmiSku: 'video-premium',
    price: 199.99,
    credits: 800,
    description: 'Maximum video generation capacity',
    popular: false,
